...
import fr.jlskyzer.erinaworld.world.biomes.BiomeCopper;
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        switch(world.provider.getDimension())
        {
            ...
            case 0:
                ...
                runGenerator(COPPER, world, random, chunkX, chunkZ, 10, BlockInit.COPPER_DIRT, BiomeCopper.class);
                runGenerator(COPPER, world, random, chunkX, chunkZ, 10, Blocks.GRASS, BiomePlains.class);
                runGenerator(COPPER, world, random, chunkX, chunkZ, 10, Blocks.DIRT, BiomePlains.class);
